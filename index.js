...
console.log('task 1b', createMenuItem("Cold Brew", 5, "Breakfast"))
console.log('task 1b', createMenuItem("Belgian Waffles", 10, "Brunch"))
...
*/
reviews.push({name: "Mabel", rating: 1, feedback: "subpar, ridiculously dirty. It's a scam!"});
console.log(reviews);
